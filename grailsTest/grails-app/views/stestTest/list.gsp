                ...
                <table class="table" style="width: auto;">
                    ...
                    <tr id="iiTestSFRow">
                        ...
                        <td style="border: 0">
                                ...
                                <g:select name="iiTestKey" from="${StestTest.constraints.iiTest.inList}"/>
                    ...
                    <tr id="ddllTestSFRow">
                        <input type="hidden" name="ddllTest" value="true"/>
                        ...
                        <td style="border: 0">
                                ...
                                <g:field name="ddllTestKey" type="number" value=""/>
                    ...
                    <tr id="dtTestSFRow" style="display: none;">
                        <input type="hidden" name="dtTest" value="false"/>
                    ...
                    <tr id="ftTestSFRow" style="display: none;">
                        <input type="hidden" name="ftTest" value="false"/>
                    ...
                    <tr id="isGoodSFRow" style="display: none;">
                        <input type="hidden" name="isGood" value="false"/>
                    ...
                    <tr id="lTestSFRow" style="display: none;">
                        <input type="hidden" name="lTest" value="false"/>
                    ...
                    <tr id="llSFRow" style="display: none;">
                        <input type="hidden" name="ll" value="false"/>
                    ...
                    <tr id="oneTestSFRow" style="display: none;">
                        <input type="hidden" name="oneTest" value="false"/>
                    ...
                    <tr id="ootSFRow" style="display: none;">
                        <input type="hidden" name="oot" value="false"/>
                    ...
                    <tr id="sTestSFRow" style="display: none;">
                        <input type="hidden" name="sTest" value="false"/>
                    ...
                    <tr id="stTestSFRow" style="display: none;">
                        <input type="hidden" name="stTest" value="false"/>
                    ...
                    <tr id="tzSFRow" style="display: none;">
                        <input type="hidden" name="tz" value="false"/>
...
<script type="text/javascript">
    BUI.use(['common/search', 'common/page'], function (Search) {
        ...
        var columns = [
                    {title: '<g:message code="stestTest.id.label" default="Id"/>', dataIndex: 'id', width: 80, renderer: function (item) {
                        return Search.createLink({
                            id: item,
                            title: '${message(code: 'stestTest.label', default: 'StestTest')}:'+item,
                            text: item,
                            href: '${createLink(action: "show")}/'+item
                        });
                    }}
                    
                             ,{title: '${message(code: 'stestTest.iiTest.label', default: 'Ii Test')}', dataIndex: 'iiTest', width: 100}
                    
                             ,{title: '${message(code: 'stestTest.bTest.label', default: 'BT est')}', dataIndex: 'bTest', width: 100}
                    
                             ,{title: '${message(code: 'stestTest.cTest.label', default: 'CT est')}', dataIndex: 'cTest', width: 100}
                    
                             ,{title: '${message(code: 'stestTest.cc.label', default: 'Cc')}', dataIndex: 'cc', width: 100}
                    
                             ,{title: '${message(code: 'stestTest.ddllTest.label', default: 'Ddll Test')}', dataIndex: 'ddllTest', width: 100}
                    
                             ,{title: '${message(code: 'stestTest.dlTest.label', default: 'Dl Test')}', dataIndex: 'dlTest', width: 100}
                    
                             ,{title: '${message(code: 'stestTest.dtTest.label', default: 'Dt Test')}', dataIndex: 'dtTest', width: 100}
                    
                             ,{title: '${message(code: 'stestTest.ftTest.label', default: 'Ft Test')}', dataIndex: 'ftTest', width: 100}
                    
                             ,{title: '${message(code: 'stestTest.isGood.label', default: 'Is Good')}', dataIndex: 'isGood', width: 100}
                    
                             ,{title: '${message(code: 'stestTest.lTest.label', default: 'LT est')}', dataIndex: 'lTest', width: 100}
                    
                             ,{title: '${message(code: 'stestTest.ll.label', default: 'Ll')}', dataIndex: 'll', width: 100}
                    
                            ,{title: '${message(code: 'stestTest.oneTest.label', default: 'One Test')}', dataIndex: 'oneTest', width: 100,renderer:function(item){
                        return Search.createLink({
                            id: item.id,
                            title:'${message(code: 'stestTest.oneTest.label', default: 'One Test')}:'+item.id,
                            text:'${message(code: 'stestTest.oneTest.label', default: 'One Test')}:'+ item.id,
                            href: '${createLink(controller: "oneTest",action: "show")}/'+item.id
                        });}}
							
                            ,{title: '${message(code: 'stestTest.oot.label', default: 'Oot')}', dataIndex: 'oot', width: 100,renderer:function(item){
                        return Search.createLink({
                            id: item.id,
                            title:'${message(code: 'stestTest.oot.label', default: 'Oot')}:'+item.id,
                            text:'${message(code: 'stestTest.oot.label', default: 'Oot')}:'+ item.id,
                            href: '${createLink(controller: "oneOverTest",action: "show")}/'+item.id
                        });}}
							
                             ,{title: '${message(code: 'stestTest.sTest.label', default: 'ST est')}', dataIndex: 'sTest', width: 100}
                    
                    ,{title: '${message(code: 'stestTest.secondTests.label', default: 'Second Tests')}', dataIndex: 'secondTests', width: 100,renderer:function(items){
                        var result="";
                        for(i=0;i<items.length;i++){
                            var item=items[i];
                            result+=Search.createLink({
                                id: item.id,
                                title:'${message(code: 'stestTest.secondTests.label', default: 'Second Tests')}:'+item.id,
                                text:'${message(code: 'stestTest.secondTests.label', default: 'Second Tests')}:'+ item.id,
